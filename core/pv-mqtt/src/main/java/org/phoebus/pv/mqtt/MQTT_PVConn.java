 ...
 *
 * <p>
 * Dispatches MQTT data to {@link MQTT_PV}s
 *
...
public class MQTT_PVConn implements MqttCallback {
    ...
    volatile private String userName = MQTT_Preferences.mqtt_username;
    volatile private String passWord = MQTT_Preferences.mqtt_password;
    ...
    /**
     * Called when message at QoS 1 or 2 acknowledges arrival at broker (QoS 0
     * will never ack)
     *
     * @see
